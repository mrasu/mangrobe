use crate::api::grpc::proto::{
    data_type, Column as ProtoColumn, CreateExternalTableResponse,
    DataType as ProtoDataType, ExternalLocation as ProtoExternalLocation,
    ...
    TableIdentifier as ProtoTableIdentifier, TimeType as ProtoTimeType,
    TimeUnit as ProtoTimeUnit,
};
use crate::domain::model::table_definition::{
    Column, DataType, ExternalLocation, FileFormat, PartitionField, PartitionTransform,
    ScalarType, StorageScheme, TableDefinition, TableIdentifier, TimeType, TimeUnit,
};
...
fn to_proto_table_definition(table: TableDefinition) -> ProtoTableDefinition {
...
fn to_proto_data_type(data_type: DataType) -> ProtoDataType {
    ProtoDataType {
        r#type: Some(match data_type {
            DataType::Scalar(scalar) => data_type::Type::Scalar(to_proto_scalar_type(scalar) as i32),
